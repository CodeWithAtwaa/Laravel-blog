                ...
                <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        ...
                        <li class="nav-item submenu @yield('categories-active') dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="nav-item"><a class="nav-link"
                                        href="{{route('theme.category' , ['id' => $item->id])}}">
                                        {{ $item->name }}</a>
                                </li>
                                @endforeach
                            </ul>
                    ...
                    <ul class="nav navbar-nav navbar-right navbar-social">
                        ...
                        <li class="nav-item submenu dropdown">
                            <a href="#" class="nav-link dropdown-toggle mx-1" data-toggle="dropdown" role="button" aria-haspopup="true"
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="nav-item">
                                    ...
                                    <a class="nav-link" href="javascript:document.getElementById('logout-form').submit();">Logout</a>
                                </li>
                            </ul>
                        </li>
                        @endif
